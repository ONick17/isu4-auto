...
class MyMainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_start.setGeometry(QtCore.QRect(150, 80, 200, 50))
        font = QtGui.QFont()
        ...
        self.lbl_select_config.setGeometry(QtCore.QRect(50, 40, 80, 20))
        self.lbl_select_config.setObjectName("lbl_select_config")
        self.lbl_error = QtWidgets.QLabel(parent=self.centralwidget)
        self.lbl_error.setGeometry(QtCore.QRect(50, 10, 400, 20))
        ...
        self.lnedit_select_config.setGeometry(QtCore.QRect(140, 40, 230, 20))
        ...
        self.btn_select_config.setGeometry(QtCore.QRect(370, 40, 70, 20))
        ...
        self.pyplot_widget.setGeometry(QtCore.QRect(20, 140, 460, 250))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_error.setText(_translate("MainWindow", "Выберите файл с прогнозом"))
    ...
    def stage_start(self):
        ...
        self.pyplot.axes.plot([0,1,2,3,4], [40,3,20,1,10])
        self.pyplot.draw()
        pass
        """
